...
package com.nu.art.software.reflection.utils;

import com.nu.art.software.reflection.exceptions.ClassInstantiationException;
import com.nu.art.software.reflection.exceptions.ConstructorNotFoundException;
import com.nu.art.software.reflection.exceptions.WrongParameterType;
	...
	private boolean checkParameters(Object... parameters)
		...
		for (int i = 0; i < parameters.length; i++) {
			if (!parameters[i].getClass().isAssignableFrom(parameterTypes[i])) {
				throw new WrongParameterType(i, parameters[i], parameterTypes[i]);
			}
		}
		return true;
	}
